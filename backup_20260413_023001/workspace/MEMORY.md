- 2026-04-10: Backup validation now includes a check for script executables. Furthermore, the `check-blog-post` cron job consistently timeouts, indicating potential WordPress API issues.

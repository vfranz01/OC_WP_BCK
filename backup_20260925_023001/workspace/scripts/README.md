...
- ✅ Daily snapshot freshness (2026-09-12): only accepts snapshots labeled
  `daily_auto_snapshot` — validation-run snapshots no longer mask a dead
  daily 02:30 UTC schedule

...
export default async function MemoryLogPage({ params }: { params: Promise<{ date: string }> }) {
  ...
  return (
    <div style={{padding:"2rem",fontFamily:"system-ui,sans-serif",color:"#e5e5e5",maxWidth:900}}>
      ...
      <div style={{whiteSpace:"pre-wrap",backgroundColor:"#1a1a1a",color:"#e5e5e5",padding:"1.5rem",borderRadius:8,border:"1px solid #2a2a2a",fontSize:14,lineHeight:1.6}}>
        {body || "(No content – only frontmatter was written by OpenClaw)"}
      </div>
    </div>
  );
}
